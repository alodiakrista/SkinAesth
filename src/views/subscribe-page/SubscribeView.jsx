...
const SubscribeView = () => {
  const discordInviteLink = 'https://discord.gg/Br7sgkFHNR';
      ...
      <section className="subscribe__content my-16 md:my-40">
        <div className="custom-container">
          <div className="subscribe__content__box flex flex-col md:flex-row items-center justify-center gap-8">
            ...
            <div className="subscribe__info flex flex-col gap-4 md:w-1/3">
              ...
              <button onClick={handleJoinDiscord} className="button button--primary">JOIN DISCORD</button>
            </div>
          </div>
        </div>
      </section>
