...
const RegisterModalComponent = ({ handleCloseModal, handleOpenModal, firstName, lastName, username, email, password, jenisKelamin, handleChangeFirstName, handleChangeLastName, handleChangeUsername, handleChangeEmail, handleChangePassword, handleChangeJenisKelamin, handleSubmit }) => (
    <section className="login__modal w-full md:w-1/2 lg:w-1/3 absolute bg-white rounded border border-gray-400 left-1/2 transform -translate-x-1/2 z-10">
        <div className="px-6 md:px-12 py-8">
            <div className="login_modal_content">
                <div className="login_modal_header mb-6 md:mb-8">
                ...
                <form className='login__modal__form my-6'>
                    ...
                    <div className='flex items-center justify-center mt-6'>
                        <button className='button button--primary' onClick={handleSubmit}>DAFTAR SEKARANG</button>
                    </div>
                </form>
            </div>
        </div>
        <div className="login_modal_footer py-4 px-6 md:px-12 bg-pink-200">
